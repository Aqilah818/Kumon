...
<body>
    ...
    <div class="search-container">
        <form method="POST" action="teacherpage2.php" class="search-bar">
                ...
                <?php if ($result_students->num_rows > 0) { ?>
                    ...
                    <?php while ($row = $result_students->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td><a href="teacherpage4.php?student_ID=<?php echo $row['student_ID']; ?>" style="color: black; text-decoration: none;"><?php echo htmlspecialchars($row['name']); ?></a></td>
